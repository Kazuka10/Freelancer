...
public class WydaniestartActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_podgl2);

        String MESSAGE = "WYMAGANE JEST POŁĄCZENIE Z SYSTEMEM SKLEPOWYM W CELU POBRANIA BAZY PRODUKTÓW " +
                "I DALSZEJ WERYFIKACJI CEN";
